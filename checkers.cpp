...
void check_knocks(short int *total_knocks, short int part)
{
    knock_present = false;
    *total_knocks = 0;
...
short int check_winner(bool sum_up)
{
    ...
    check_knocks(&knock_compMoves, 1);
